...
const choosePrice = document.querySelector("#choosePrice");

console.log(choosePrice.value)
...
function loadProductInfo() {
    ...
    if (storedProductInfo !== null) {
        for (let key of storedProductInfo){
...
function listCard() {
    ...
    for (let index = 0; index < productInfo.length; index++) {
        if (productInfo[index].Availability.toLocaleLowerCase() === "pre-order"){
